...
headers = {
    ...
    'Referer': 'https://github.com/UCF-Data-Project-2/nba-visualization',
...
with open('static/db/data.json', 'r') as stats_step1:
    stats_json_step1 = json.load(stats_step1)

with open('static/db/data.json', 'r') as stats_step2:
    stats_json_step2 = json.load(stats_step2)

with open('static/db/data.json', 'r') as stats_step3:
    stats_json_step3 = json.load(stats_step3)

with open('static/db/data.json', 'r') as stats_step4:
...
def post_user_inputs():
    ...
    # player_id = req['playerId'].strip() (lebron id 785018)
